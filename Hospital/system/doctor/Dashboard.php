...
$appoint = mysqli_query($con, "SELECT * FROM appoint where app_doc_id='$iiid'");
   ...
   <div class="card mb-3">
      <div class="card-body">
         <div class="panel-body text-center">
            <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x" style="opacity:0.2;"></i> <i class="fa fa-user" style="color:#3cd2a5"></i> </span>
