               ...
               <tbody>
                  <?php 
                     ...
                     while ($row = mysqli_fetch_array($fetch_cat)) {
                       ...
                       <a href="patients.php?eid='.$row[0].'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-edit"></span></a>
                       <a href="patients.php?delid='.$row[0].'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a></td></tr>' ;      
