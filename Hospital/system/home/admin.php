...
else
{
        ...
        if(isset($_POST["btn"]))
        {
            ...
            $login = mysqli_query($con,"select * from admin where admin_name='$uemail' && admin_pass='$upassword'");
            ...
            <div class="login-content">
                <form method="POST" name="login_form" autocomplete="off">
                    ...
                    <div class="mb-3">
                       ...
                       <input type="text" name="txtemail" class="form-control form-control-lg bg-white bg-opacity-5" value="" placeholder="" required />
                    </div>
                    <div class="mb-3">
                        <div class="d-flex">
